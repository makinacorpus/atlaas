...
ELASTICSEARCH_SECURED = "{{data.ELASTICSEARCH_SECURED}}"
ELASTICSEARCH_SECURED_USER = "{{data.ELASTICSEARCH_SECURED_USER}}"
ELASTICSEARCH_SECURED_PASSWORD = "{{data.ELASTICSEARCH_SECURED_PASSWORD}}"
...
MAIL_DEFAULT_TO = "{{data.MAIL_DEFAULT_TO}}"
