...
window.atlaas = {
    ...
    Routers: {},
    CONFIG: {
        elasticsearch: 'https://ovh-g1-1-es.makina-corpus.net/atlaas',
        secure_elasticsearch: 'https://ovh-g1-1-es.makina-corpus.net/atlaas',
        backend: 'http://annuaire.makina-corpus.net',
    },
    init: function () {
        'use strict';
